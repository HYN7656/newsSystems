        ...
        <el-row>
          ...
          <el-col :span="11" :offset="2">
            <div class="cell">
              ...
              <el-form-item label="来源：" prop="eFrom">
              <el-input v-model="addObject.eFrom" placeholder="请输入内容" class="flew-input"></el-input>
              </el-form-item>
            </div>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="11" :offset="2">
            <div class="cell">
              <el-form-item label="来源：" prop="eFrom">
              <!--<span class="name">来源：</span>-->
              <el-input v-model="editObject.eFrom" placeholder="请输入内容" class="flew-input"></el-input>
              </el-form-item>
            </div>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      getPage() {
        ...
        API.get('/energy/findAll', params,{Authorization:storage.get('token')}).then((res) => {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(this.num == 1) {
              ...
              params['eFrom'] = this.addObject.eFrom;
              params['systemId'] = storage.get('sysid');
              // console.log(params);
              API.post('/energy/create', params,{Authorization:storage.get('token')}).then((res) => {
                // console.log(res.data)
                if (res.data.code == 200) {
                  this.addPop = false;
                  this.getPage();
      ...
      editOpen(id) {
        ...
        let params = {};
        params['id'] = id;
        API.get('/energy/findById', params,{Authorization:storage.get('token')}).then((res) => {
          // console.log(res.data);
          if (res.data.code == 200) {
      ...
      // 查看
      linkDetail(id) {
        this.$router.push({name: 'backstage.energy.detail', query: {id: id}});
      },
