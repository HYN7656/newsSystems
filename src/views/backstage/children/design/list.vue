      ...
      <div class="content">
        <el-row>
          ...
          <el-col :span="11" :offset="2">
            <div class="cell">
              <el-form-item label="来源：" prop="dFrom">
              <!--<span class="name">来源：</span>-->
              <el-input v-model="addObject.dFrom" placeholder="请输入内容" class="flew-input"></el-input>
              </el-form-item>
            </div>
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="11" :offset="2">
            <div class="cell">
              <!--<span class="name">来源：</span>-->
              <el-form-item label="来源：" prop="dFrom">
              <el-input v-model="editObject.dFrom" placeholder="请输入内容" class="flew-input"></el-input>
              </el-form-item>
            </div>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      getPage() {
        ...
        API.get('/design/findAll', params,{Authorization:storage.get('token')}).then((res) => {
      ...
      editOpen(id) {
        ...
        let params = {};
        params['id'] = id;
        API.get('/design/findById', params,{Authorization:storage.get('token')}).then((res) => {
          // console.log(res.data);
          if (res.data.code == 200) {
          ...
          if (valid) {
            if(this.EditName == this.editObject.title){
              ...
              if(this.num == 1) {
                ...
                params['systemId'] = storage.get('sysid');
                // console.log(params);
                API.post('/design/update', params,{Authorization:storage.get('token')}).then((res) => {
                  if (res.data.code == 200) {
                    this.editPop = false;
                    this.getPage();
                    this.$message({
              ...
              API.get('/design/findByTitle', tit, {Authorization: storage.get('token')}).then((res) => {
                if (res.data.code == 200) {
                  this.num ++;
                  if(this.num == 1) {
                    this.loadingBtn = true;
      ...
      del(id) {
        this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
          ...
          params['id'] = id;
          params['systemId'] = storage.get('sysid');
          API.delete('/design/delete', params,{Authorization:storage.get('token')}).then((res) => {
            if (res.data.code == 200) {
              this.getPage();
              this.$message({
                type: 'success',
      ...
      // 查看
      linkDetail(id) {
        this.$router.push({name: 'backstage.design.detail', query: {id: id}});
      },
